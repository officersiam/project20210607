<?php
    ...
    function contact(){
        ...
        $contactSql = "INSERT INTO contact (`name`, `email`, `subject`, `comments`, `contact_created_date`, `contact_created_time`)
                          VALUES('$name', '$email', '$subject', '$comments', '$contact_created_date', '$contact_created_time')";
    ...
    function contact_update(){
        ...
        $contactUpdateSql = "UPDATE contact SET `name` = '$name', `email` = '$email', `subject` = '$subject', `comments` = '$comments' WHERE `contact_id` = '$contact_id' ";
