<?php
    ...
    function sitesetting(){
        ...
        $site_setting_business_hour = stripslashes($_REQUEST['site_setting_business_hour']);
        $site_setting_business_hour = mysqli_real_escape_string($db,$site_setting_business_hour);
