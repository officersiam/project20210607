...
?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" id="editor" class="form-control" name="site_setting_business_hour" aria-describedby="siteBusinessHourHelp"><?php echo $site_setting_business_hour;?></textarea>
                            <small id="siteBusinessHourHelp" class="form-text text-muted">Type Your Business Hour Here.</small>
                        </div>
<?php } ?>
